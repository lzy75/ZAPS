# 实验 20260817_235811_motion_deblur_imagenet_00019

- 代码版本: `8111950` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00019.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=14.61** / SSIM=0.2067 / LPIPS=0.6212（观测基线 PSNR=16.53）
- NFE=330（优化300+采样30）
- 耗时: 优化=46.25s + 采样=4.59s = 合计 **50.84s**
