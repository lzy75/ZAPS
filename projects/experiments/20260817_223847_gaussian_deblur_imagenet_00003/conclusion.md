# 实验 20260817_223847_gaussian_deblur_imagenet_00003

- 代码版本: `8782aa2` (branch=master, dirty=True)
- 任务 / 数据集: **gaussian_deblur** / imagenet，图像 `00003.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=15.47** / SSIM=0.3027 / LPIPS=0.5239（观测基线 PSNR=20.99）
- NFE=330（优化300+采样30）
- 耗时: 优化=54.63s + 采样=5.58s = 合计 **60.22s**
