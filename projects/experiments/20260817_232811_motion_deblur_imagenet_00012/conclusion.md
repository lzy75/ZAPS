# 实验 20260817_232811_motion_deblur_imagenet_00012

- 代码版本: `8111950` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00012.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=17.87** / SSIM=0.1844 / LPIPS=0.6627（观测基线 PSNR=21.97）
- NFE=330（优化300+采样30）
- 耗时: 优化=49.52s + 采样=4.97s = 合计 **54.49s**
