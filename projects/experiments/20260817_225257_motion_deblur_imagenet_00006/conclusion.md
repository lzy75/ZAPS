# 实验 20260817_225257_motion_deblur_imagenet_00006

- 代码版本: `8782aa2` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00006.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=13.74** / SSIM=0.2131 / LPIPS=0.6979（观测基线 PSNR=15.46）
- NFE=330（优化300+采样30）
- 耗时: 优化=48.08s + 采样=5.12s = 合计 **53.20s**
