# 实验 20260816_234237_motion_deblur_ffhq_00004

- 代码版本: `8dc8655` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / ffhq，图像 `00004.png`
- 关键参数: steps=30 schedule=(15, 10, 5) epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=20.06** / SSIM=0.6061 / LPIPS=0.3243（观测基线 PSNR=17.83）
- NFE=330（优化300+采样30）
- 耗时: 优化=22.37s + 采样=2.37s = 合计 **24.74s**
