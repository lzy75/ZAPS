# 实验 20260818_010456_gaussian_deblur_ffhq_00008

- 代码版本: `d5d65fc` (branch=master, dirty=True)
- 任务 / 数据集: **gaussian_deblur** / ffhq，图像 `00008.png`
- 关键参数: steps=30 schedule=(15, 10, 5) epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=26.66** / SSIM=0.7711 / LPIPS=0.1250（观测基线 PSNR=24.49）
- NFE=300（优化300+采样0）
- 耗时: 优化=36.51s + 采样=0.00s = 合计 **36.51s**
