# 实验 20260817_224428_motion_deblur_imagenet_00004

- 代码版本: `8782aa2` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00004.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=15.55** / SSIM=0.0954 / LPIPS=0.6983（观测基线 PSNR=23.41）
- NFE=330（优化300+采样30）
- 耗时: 优化=60.13s + 采样=5.31s = 合计 **65.44s**
