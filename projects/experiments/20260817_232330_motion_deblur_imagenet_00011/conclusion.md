# 实验 20260817_232330_motion_deblur_imagenet_00011

- 代码版本: `8111950` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00011.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=15.80** / SSIM=0.1558 / LPIPS=0.6148（观测基线 PSNR=19.47）
- NFE=330（优化300+采样30）
- 耗时: 优化=55.87s + 采样=6.02s = 合计 **61.89s**
