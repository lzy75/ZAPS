# 实验 20260817_224852_motion_deblur_imagenet_00005

- 代码版本: `8782aa2` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00005.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=11.77** / SSIM=0.1272 / LPIPS=0.8193（观测基线 PSNR=13.13）
- NFE=330（优化300+采样30）
- 耗时: 优化=48.21s + 采样=4.78s = 合计 **52.98s**
