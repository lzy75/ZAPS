# 实验 20260817_231838_motion_deblur_imagenet_00010

- 代码版本: `8111950` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00010.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=14.35** / SSIM=0.2209 / LPIPS=0.6542（观测基线 PSNR=19.51）
- NFE=330（优化300+采样30）
- 耗时: 优化=54.54s + 采样=4.26s = 合计 **58.80s**
