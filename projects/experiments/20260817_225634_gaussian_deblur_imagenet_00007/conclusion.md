# 实验 20260817_225634_gaussian_deblur_imagenet_00007

- 代码版本: `8111950` (branch=master, dirty=True)
- 任务 / 数据集: **gaussian_deblur** / imagenet，图像 `00007.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=16.24** / SSIM=0.2639 / LPIPS=0.6298（观测基线 PSNR=21.33）
- NFE=330（优化300+采样30）
- 耗时: 优化=51.36s + 采样=4.93s = 合计 **56.29s**
