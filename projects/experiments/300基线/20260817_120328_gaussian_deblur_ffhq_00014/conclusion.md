# 实验 20260817_120328_gaussian_deblur_ffhq_00014

- 代码版本: `97ea328` (branch=master, dirty=True)
- 任务 / 数据集: **gaussian_deblur** / ffhq，图像 `00014.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=25.93** / SSIM=0.7406 / LPIPS=0.1311（观测基线 PSNR=24.53）
- NFE=330（优化300+采样30）
- 耗时: 优化=24.22s + 采样=2.16s = 合计 **26.38s**
