# 实验 20260817_223524_motion_deblur_imagenet_00002

- 代码版本: `8782aa2` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00002.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=16.12** / SSIM=0.1477 / LPIPS=0.6298（观测基线 PSNR=22.20）
- NFE=330（优化300+采样30）
- 耗时: 优化=51.18s + 采样=6.11s = 合计 **57.29s**
