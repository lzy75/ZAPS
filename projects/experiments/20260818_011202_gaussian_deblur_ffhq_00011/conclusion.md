# 实验 20260818_011202_gaussian_deblur_ffhq_00011

- 代码版本: `d5d65fc` (branch=master, dirty=True)
- 任务 / 数据集: **gaussian_deblur** / ffhq，图像 `00011.png`
- 关键参数: steps=30 schedule=(15, 10, 5) epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=25.51** / SSIM=0.8118 / LPIPS=0.1510（观测基线 PSNR=23.31）
- NFE=300（优化300+采样0）
- 耗时: 优化=33.41s + 采样=0.00s = 合计 **33.41s**
