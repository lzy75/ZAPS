# 实验 20260817_230613_motion_deblur_imagenet_00008

- 代码版本: `8111950` (branch=master, dirty=True)
- 任务 / 数据集: **motion_deblur** / imagenet，图像 `00008.png`
- 关键参数: steps=30 schedule=[15, 10, 5] epochs=10 lr=0.001 zeta_init=0.2 d_init=0.2 wave=db4 level=3
- 指标: **PSNR=14.10** / SSIM=0.1783 / LPIPS=0.6021（观测基线 PSNR=21.41）
- NFE=330（优化300+采样30）
- 耗时: 优化=97.88s + 采样=10.52s = 合计 **108.40s**
